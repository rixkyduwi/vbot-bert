...
def retraining():
    ...
    documents = []
    ignore_words = ["?", "!"]
    data_file = open("chatbotdoni/intents.json").read()
    ...
    pickle.dump(words, open("chatbotdoni/words.pkl", "wb"))
    pickle.dump(classes, open("chatbotdoni/classes.pkl", "wb"))
    ...
    model.save("chatbotdoni/chatbot_model.h5", hist)
    print("model created")
